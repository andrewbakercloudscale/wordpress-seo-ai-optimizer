...
End your response with EXACTLY one of: BUILD_STATUS: PASS or BUILD_STATUS: FAIL" \
    ...
    _review_section "s1" cloudscale-seo-ai-optimizer.php includes/class-cs-seo-utils.php uninstall.php includes/trait-auto-pipeline.php includes/trait-readability.php readme.txt &
