        ...
        <div class="ab-pane" id="ab-pane-titleopt">
            ...
            <div class="ab-zone-card ab-card-titleopt" style="margin-top:0">
                ...
                <div id="ab-titleopt-summary" class="ab-summary-row">
                    ...
                    <div class="ab-summary-card"><div class="ab-summary-num" id="titleopt-s-session" style="color:#2271b1">0</div><div class="ab-summary-lbl">This Session</div></div>
                </div>
            ...
            function toRenderTable() {
                ...
                var rows = page.map(function(p, idx) {
                    ...
                    var titleInner   = abEsc(displayTitle)
                        + (noOriginal ? '<div style="font-size:10px;color:#aaa;font-style:italic;margin-top:2px">re-analyse to compare originals</div>' : '');
                    var titleCell = p.edit_link
                        ? '<a href="' + safeHref(p.edit_link) + '" target="_blank" style="color:#1d2327;text-decoration:none;border-bottom:1px dotted #aaa" title="Edit post">' + titleInner + '</a>'
                        : titleInner;
